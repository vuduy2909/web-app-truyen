...
class ListTopViewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.titleList.text = "XẾP HẠNG LƯỢT XEM"
        recyclerView = binding.recyclerView

        loadListDataHelper = LoadListDataHelper(requireContext(), TypeStoryEnum.TOP_VIEWS)
